...
public class FalconBanditModel implements BanditModel {
  ...
  public Map<String, Double> weighActions(
    ...
    Map<String, Double> actionScores =
                    ...
                    e -> {
                      ...
                      actionScore +=
                          scoreContextForCoefficients(
                              actionAttributes, banditCoefficients.getActionNumericCoefficients());
                      actionScore +=
                          scoreContextForCoefficients(
                              actionAttributes,
    ...
    Map<String, Double> actionWeights =
        computeActionWeights(
            actionScores, modelData.getGamma(), modelData.getActionProbabilityFloor());
    return actionWeights;
  }

  private static double scoreContextForCoefficients(
      EppoAttributes context, Map<String, ? extends AttributeCoefficients> coefficients) {
  ...
  private static Map<String, Double> computeActionWeights(
